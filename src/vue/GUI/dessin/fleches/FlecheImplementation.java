...
/**
 * Represente une fleche d'implementation (realisation) UML. 
 * Dessine un trait pointille termine par un triangle vide.
 */
public class FlecheImplementation extends Fleche
{
	...
	/**
	 * Construit une fleche d'implementation avec des coordonnees entieres.
	 *
	 ...
	 */
	public FlecheImplementation(int xd, int yd, int xf, int yf, boolean bidirectionnel, Color couleur, Association association)
	{
		super(xd, yd, xf, yf, bidirectionnel, couleur, association);
	}

	/**
	 * Construit une fleche d'implementation avec des valeurs par defaut.
	 *
	 * @param xd Coordonnee X de depart.
	 * @param yd Coordonnee Y de depart.
	 * @param xf Coordonnee X d'arrivee.
	 ...
	 * @param association L'objet metier associe a cette fleche.
	 */
	public FlecheImplementation(int xd, int yd, int xf, int yf, Association association)
	{
		super(xd, yd, xf, yf, Fleche.BIDIRECTIONNEL_PAR_DEFAUT, Fleche.COULEUR_PAR_DEFAUT, association);
	}

	/**
	 * Construit une fleche d'implementation a partir de deux points.
	 *
	 * @param debut Point de depart.
	 * @param fin Point d'arrivee.
	 * @param association L'objet metier associe a cette fleche.
	 */
	public FlecheImplementation( Point debut, Point fin, Association association )
	{
		super(debut.x, debut.y, fin.x, fin.y, Fleche.BIDIRECTIONNEL_PAR_DEFAUT, Fleche.COULEUR_PAR_DEFAUT, association);
	}

	/**
	 * Construit une fleche d'implementation avec choix de la direction.
	 *
	 * @param debut Point de depart.
	 * @param fin Point d'arrivee.
	 ...
	 * @param association L'objet metier associe a cette fleche.
	 */
	public FlecheImplementation( Point debut, Point fin, boolean bidirectionnel, Association association)
	{
		super(debut.x, debut.y, fin.x, fin.y, bidirectionnel, Fleche.COULEUR_PAR_DEFAUT, association);
	}

	/**
	 * Construit une fleche d'implementation complete a partir de deux points.
	 *
	 * @param debut Point de depart.
	 * @param fin Point d'arrivee.
	 * @param bidirectionnel Vrai pour afficher le symbole aux deux bouts.
	 ...
	 */
	public FlecheImplementation( Point debut, Point fin, boolean bidirectionnel, Association association, Color couleur)
	{
	...
	/**
	 * Dessine la fleche d'implementation sur le contexte graphique.
	 * Trace un trait pointille et un triangle vide (tete) a l'extremite.
	 *
	...
	public void draw(Graphics2D g)
	{
		...
		if ( this.getAssociation().estReflexive() ) { Fleche.drawLignePointilleAutoAsso(g, xd, yd, xf, yf); }
		else                                        { Fleche.drawLignePointille        (g, xd, yd, xf, yf); }
